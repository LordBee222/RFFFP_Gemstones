...
public class RFFFPGemstonesBlocks {
    ...
    public static final Block DEEPSLATE_AMBER_ORE = registerBlock("deepslate_amber_ore",
            new Block(FabricBlockSettings.copy(Blocks.DEEPSLATE).strength(4.5f).requiresTool()),
            RFFFPGemstonesItemGroups.RFFFPG);
    ...
    public static final Block OPAL_ORE = registerBlock("opal_ore",
            new Block(FabricBlockSettings.copy(Blocks.END_STONE).strength(3f).requiresTool()),
            RFFFPGemstonesItemGroups.RFFFPG);
    public static final Block RUBY_ORE = registerBlock("ruby_ore",
            new Block(FabricBlockSettings.copy(Blocks.NETHERRACK).strength(0.4f).requiresTool()),
            RFFFPGemstonesItemGroups.RFFFPG);

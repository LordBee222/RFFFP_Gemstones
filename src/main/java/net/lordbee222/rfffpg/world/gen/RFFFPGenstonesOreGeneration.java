...
public class RFFFPGenstonesOreGeneration {
    public static void generateOres(){
        BiomeModifications.addFeature(BiomeSelectors.includeByKey(BiomeKeys.BADLANDS, BiomeKeys.ERODED_BADLANDS,BiomeKeys.WOODED_BADLANDS),
                GenerationStep.Feature.UNDERGROUND_ORES, RFFFPGemstonesPlacedFeatures.AMBER_ORE_PLACED.getKey().get());
        ...
        BiomeModifications.addFeature(BiomeSelectors.includeByKey(BiomeKeys.JUNGLE, BiomeKeys.BAMBOO_JUNGLE,BiomeKeys.SPARSE_JUNGLE),
                GenerationStep.Feature.UNDERGROUND_ORES, RFFFPGemstonesPlacedFeatures.JADE_ORE_PLACED.getKey().get());

        BiomeModifications.addFeature(BiomeSelectors.includeByKey(BiomeKeys.MUSHROOM_FIELDS),
                GenerationStep.Feature.UNDERGROUND_ORES, RFFFPGemstonesPlacedFeatures.JASPER_ORE_PLACED.getKey().get());

        BiomeModifications.addFeature(BiomeSelectors.foundInTheNether(),
                GenerationStep.Feature.UNDERGROUND_ORES, RFFFPGemstonesPlacedFeatures.RUBY_ORE_PLACED.getKey().get());

        BiomeModifications.addFeature(BiomeSelectors.foundInTheEnd(),
                GenerationStep.Feature.UNDERGROUND_ORES, RFFFPGemstonesPlacedFeatures.OPAL_ORE_PLACED.getKey().get());
        ...
        BiomeModifications.addFeature(BiomeSelectors.includeByKey(
                ...
                GenerationStep.Feature.UNDERGROUND_ORES, RFFFPGemstonesPlacedFeatures.SAPPHIRE_ORE_PLACED.getKey().get());

        BiomeModifications.addFeature(BiomeSelectors.includeByKey(BiomeKeys.FLOWER_FOREST),
                GenerationStep.Feature.UNDERGROUND_ORES, RFFFPGemstonesPlacedFeatures.TOPAZ_ORE_PLACED.getKey().get());
    }
}
